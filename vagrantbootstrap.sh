...
function setup_virtualenv() {
    ...
    progress mkvirtualenv nix
}

function install_nix_requirements() {
    echo "installing nix requirements"
    workon nix
    cd /vagrant
...
function prepare_and_run_nix() {
    workon nix
    cd /vagrant
    cp nix/settings/example-local.py nix/settings/local.py
